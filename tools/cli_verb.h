...
#define CLI_STEP_GETS 2
#define CLI_STEP_IDNT 3
#define CLI_STEP_REGS 4
#define CLI_STEP_JOIN 5
#define CLI_STEP_VOTE 6
#define CLI_STEP_OPEN 7
